...
urlpatterns = [
    ...
    path('profile/<user_id>', views_accounts.ForeasProfile.as_view() , name='foreas_profile'),
    path('profile/<user_id>', views_accounts.YpAnProfile.as_view() , name='ypan_profile'),
    path('profile/<user_id>', views_accounts.EsydProfile.as_view() , name='esyd_profile'),
